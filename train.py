...
def run_data_prep(
    ...
    # Calculate mean squared error (MSE) and log it to Weights & Biases
    mse = mean_squared_error(y_val, y_val_pred)
    wandb.log({"MSE": mse})

    # Save the trained model as regressor.pkl
    model_filename = os.path.join(dest_path, "regressor.pkl")
    dump_pickle(model, model_filename)
